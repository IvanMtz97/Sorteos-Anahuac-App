...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.validarConexion = function () {
        ...
        console.log("validarConexion()");
        console.log("none -> " + connectivity.connectionType.none);
        console.log("mobile -> " + connectivity.connectionType.mobile);
        console.log("wifi -> " + connectivity.connectionType.wifi);
